...
@section('title', __('Ventilator Analyzer'))
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-8 order-md-1 order-last">
                    <h5>{{ __('Ventilator Analyzer') }} {{ $data->kode_inventaris }}</h5>
                </div>
            </div>
        </div>
                        ...
                        <div class="card-body">
                            <form action="{{ route('sertifikatSave') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="form-group">
                                        <label for="uc_suhu">{{ __('Slope') }}</label>
                                        <div class="row">
                                            <div class="col">
                                                <input type="number" step="0.00000000000000001" class="form-control"
                                                    placeholder="Slope" name="slope_flow_meter" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <input type="number" step="0.00000000000000001" class="form-control"
                                                    placeholder="Intersept" name="intercept_flow_meter" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <input type="number" step="0.00000000000000001" class="form-control"
                                                    placeholder="Slope" name="slope_konsentrasi_oksigen" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <input type="number" step="0.00000000000000001" class="form-control"
                                                    placeholder="Intersept" name="intercept_konsentrasi_oksigen" required>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <table class="table table-xs table-bordered" id="data-table" width="100%"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th colspan="2">Konsentrasi Oksigen</th>
                                    ...
                                    <tbody>
                                        @foreach ($dataSertifikat as $row)
                                            ...
                                            <tr>
                                                <td>{{ $row->tahun }}</td>
                                                <td>{{ $data->slope_flow_meter }}</td>
                                                <td>{{ $data->intercept_flow_meter }}</td>
                                                <td>{{ $data->slope_konsentrasi_oksigen }}</td>
                                                <td>{{ $data->intercept_konsentrasi_oksigen }}</td>
                                                <td rowspan="5"><a
