...
@section('title', __('Phototherapy Radiometer'))
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-8 order-md-1 order-last">
                    <h5>{{ __('Phototherapy Radiometer') }} {{ $data->kode_inventaris }}</h5>
                </div>
            </div>
        </div>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <input type="number" step="0.00000000000000001" class="form-control"
                                                    placeholder="Slope" name="slope" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <input type="number" step="0.00000000000000001" class="form-control"
                                                    placeholder="Intersept" name="intercept" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="uc_suhu">{{ __('Uncert') }}</label>
                                        <div class="row">
                                            <div class="col">
                                                <input type="number" step="0.00000000000000001" class="form-control"
