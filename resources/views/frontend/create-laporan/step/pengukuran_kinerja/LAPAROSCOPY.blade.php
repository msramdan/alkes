...
<div class="container bg-white p-4 rounded shadow">
        ...
        <table class="table table-bordered">
            ...
            <tbody class="text-center">
                <tr>
                    <td>200</td>
                    <td>250</td>
                    <td><input name="cutting_1" type="number" step="0.01" required
                            class="form-control form-control-sm"></td>
                    <td><input name="cutting_2" type="number" step="0.01" required
                            class="form-control form-control-sm"></td>
                    <td><input name="cutting_3" type="number" step="0.01" required
                            class="form-control form-control-sm"></td>
        ...
        <table class="table table-bordered">
            ...
            <tbody class="text-center">
                <tr>
                    <td>200</td>
                    <td>80</td>
                    <td><input name="coagulating_1" type="number" step="0.01" required
                            class="form-control form-control-sm"></td>
                    <td><input name="coagulating_2" type="number" step="0.01" required
                            class="form-control form-control-sm"></td>
                    <td><input name="coagulating_3" type="number" step="0.01" required
                            class="form-control form-control-sm"></td>
                    <td>≤ 4.5 watt pada nilai 150 mA</td>
                </tr>
            </tbody>
    ...
    <div class="mb-3 d-flex flex-column gap-1">
        <div class="d-flex align-items-center">
            ...
            <input type="number" class="form-control form-control-sm highlight w-25">
    ...
    <div class="mb-3">
        <div class="form-check form-check-inline">
            <input class="form-check-input" type="checkbox" id="surgicalTracheal">
            <label class="form-check-label" for="surgicalTracheal">Surgical / Tracheal</label>
        </div>
        <div class="form-check form-check-inline">
            <input class="form-check-input" type="checkbox" id="lowVolumeThoracic">
