            ...
            <form action="{{ url('/web/history_laporan/kondisi-lingkungan') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-2">
                    <div class="col">
                        ...
                        <input type="text" class="form-control" readonly placeholder="" aria-label="First name" name="suhu_awal" value="{{ $kondisi_lingkungan->suhu_awal }}">
                    </div>
                    <div class="col">
                        <label for="" style=" font-size: 12px;">Suhu Akhir (°C)</label>
                        <input type="text" class="form-control" readonly placeholder="" aria-label="Last name" name="suhu_akhir" value="{{ $kondisi_lingkungan->suhu_akhir }}">
                    </div>
                </div>
                @endif
                ...
                <div class="row mb-2">
                    <div class="col">
                        ...
                        <input type="text" class="form-control" readonly placeholder="" aria-label="First name" name="kelembapan_ruangan_awal" value="{{ $kondisi_lingkungan->kelembapan_ruangan_awal }}">
                    </div>
                    <div class="col">
                        <label for="" style=" font-size: 12px;">Kelembaban Ruangan Akhir (%)</label>
                        <input type="text" class="form-control" readonly placeholder="" aria-label="Last name" name="kelembapan_ruangan_akhir" value="{{ $kondisi_lingkungan->kelembapan_ruangan_akhir }}">
                    </div>
                </div>
                @endif
            </form>
