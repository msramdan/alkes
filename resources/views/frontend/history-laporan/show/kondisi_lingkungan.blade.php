            ...
            <form action="{{ url('/web/history_laporan/kondisi-lingkungan') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-2">
                    <div class="col">
                        ...
                        <input type="text" class="form-control" readonly name="suhu_awal" value="{{ $dataLaporan['suhu_awal'] }}">
                    </div>
                    <div class="col">
                        <label for="" style="font-size: 12px;">Suhu Akhir (°C)</label>
                        <input type="text" class="form-control" readonly name="suhu_akhir" value="{{ $dataLaporan['suhu_akhir'] }}">
                    </div>
                </div>
                @endif
                ...
                <div class="row mb-2">
                    <div class="col">
                        ...
                        <input type="text" class="form-control" readonly name="kelembapan_ruangan_awal" value="{{ $dataLaporan['kelembapan_ruangan_awal'] }}">
                    </div>
                    <div class="col">
                        <label for="" style="font-size: 12px;">Kelembapan Ruangan Akhir (%)</label>
                        <input type="text" class="form-control" readonly name="kelembapan_ruangan_akhir" value="{{ $dataLaporan['kelembapan_ruangan_akhir'] }}">
                    </div>
                </div>
                @endif
            </form>
