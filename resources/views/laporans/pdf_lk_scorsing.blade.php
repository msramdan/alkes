...
<body>
    ...
    @elseif ($nomenklaturs->id == config('nomenklatur.EXAMINATION_LAMP'))
        @include('laporans._pdf_lk_scorsing.score_examination_lamp')
    ...
    @elseif ($nomenklaturs->id == config('nomenklatur.Bed_Electric'))
        @include('laporans._pdf_lk_scorsing.score_bed_electric')
    ...
    @elseif ($nomenklaturs->id == config('nomenklatur.MIKROSKOP'))
        @include('laporans._pdf_lk_scorsing.MIKROSKOP')
            @elseif ($nomenklaturs->id == config('nomenklatur.NEBULIZER'))
        @include('laporans._pdf_lk_scorsing.NEBULIZER')
    @endif
