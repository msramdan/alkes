...
// ======================
$contact_tachometer = DB::table('laporan_kinerja')->where('type_laporan_kinerja', 'contact_tachometer')->where('no_laporan', $laporan->no_laporan)->first();
...
// kinerja waktu
$kinerja_waktu = DB::table('laporan_kinerja')->where('type_laporan_kinerja', 'kinerja_waktu')->where('no_laporan', $laporan->no_laporan)->first();
