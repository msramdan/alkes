...
<tbody>
    @foreach ($myArrayWaktu as $key => $value)
        <tr>
            <td style="text-align: center;vertical-align: middle;">{{ $key }}</td>
            <td style="text-align: center;vertical-align: middle;" colspan="2">{{ $value['percobaan_1'] }}</td>
            <td style="text-align: center;vertical-align: middle;" colspan="2">{{ $value['percobaan_2'] }}</td>
            <td style="text-align: center;vertical-align: middle;" colspan="2">{{ $value['percobaan_3'] }}</td>
            <td style="text-align: center;vertical-align: middle;">{{ round($value['mean'], 2) }}</td>
            <td style="text-align: center;vertical-align: middle;">{{ round($value['tol'], 2) }}</td>
        </tr>
    @endforeach
