...
<!-- Heart Rate Table -->
<p style="font-size: 11px;margin-left:18px"><b>Kinerja Putara</b></p>
<table class="table table-bordered table-sm"
    ...
    <tr>
        ...
        <th colspan="6" style="text-align: center;vertical-align: middle;">Terukur Pada Standar (LPM)</th>
    ...
    @foreach ($kinerjaPutaranData as $data)
        <tr>
            <td style="text-align: center;vertical-align: middle;">{{ $data['remark'] }}</td>
            @for ($i = 1; $i <= 6; $i++)
...
<table class="table table-bordered table-sm"
    ...
    <tr>
        <th rowspan="2" style="text-align: center;vertical-align: middle;">Setting Standar</th>
        <th colspan="3" style="text-align: center;vertical-align: middle;">Terukur Pada Standar (LPM)</th>
        <th rowspan="2" style="text-align: center;vertical-align: middle;">Mean Terkoreksi</th>
