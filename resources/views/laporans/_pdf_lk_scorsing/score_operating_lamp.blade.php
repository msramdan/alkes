...
$intensitas_cahaya = DB::table('laporan_kinerja')
    ->where('type_laporan_kinerja', 'intensitas_cahaya_lengan_1')
    ->where('no_laporan', $laporan->no_laporan)
    ->first();
...
$intensitas_cahaya2 = DB::table('laporan_kinerja')
    ->where('type_laporan_kinerja', 'intensitas_cahaya_lengan_2')
    ->where('no_laporan', $laporan->no_laporan)
    ->first();
...
<tbody>
    ...
    <tr>
        ...
        <td style="text-align: center;">{{ (($scoreKinerja + $scoreKinerja2 )/2) }}</td>
    </tr>
</tbody>
</table>
<table class="table table-bordered table-sm"
