...
<table class="table table-bordered table-sm"
    ...
    @foreach ($akurasiWaktuData as $data)
        <tr>
            ...
            @if ($data['detik'] == 300)
                <td style="text-align: center;vertical-align: middle;" rowspan="3">{{ $akurasiWaktuFinalScore }}
                </td>
                <td style="text-align: center;vertical-align: middle;" rowspan="3">{{ $akurasiWaktuRequirement }}
                </td>
            @endif
        </tr>
    @endforeach
