...
$flowmeter = DB::table('laporan_kinerja')->where('type_laporan_kinerja', 'flowmeter_hfnc')->where('no_laporan', $laporan->no_laporan)->first();
...
{{-- konsentrasi oksigen --}}
<?php
$oksigen = DB::table('laporan_kinerja')->where('type_laporan_kinerja', 'konsentrasi_oksigen_hfnc')->where('no_laporan', $laporan->no_laporan)->first();
...
<table class="table table-bordered table-sm"
    ...
    @foreach ($oksigenData as $data)
        <tr>
            ...
            <td style="text-align: center;vertical-align: middle;">{{ $data['result'] }}</td>
            @if ($data['setting'] == 21)
                <td style="text-align: center;vertical-align: middle;" rowspan="3">{{ $oksigenFinalScore }}</td>
                <td style="text-align: center;vertical-align: middle;" rowspan="3">{{ $oksigenRequirement }}</td>
            @endif
        </tr>
    @endforeach
</table>
