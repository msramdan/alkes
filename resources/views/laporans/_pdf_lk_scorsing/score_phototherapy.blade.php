...
<table class="table table-bordered table-sm"
    ...
    @foreach ($spectralIrradianceData as $data)
        <tr>
            ...
            @if ($data['rate'] == 'Max')
                <td style="text-align: center;vertical-align: middle;">{{ $spectralIrradianceFinalScore }}</td>
                <td style="text-align: center;vertical-align: middle;">{{ $spectralIrradianceRequirement }}
                </td>
            @endif
        </tr>
    @endforeach
